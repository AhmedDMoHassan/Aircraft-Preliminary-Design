...
SWing = MTOW/WperS;                         % Area of the wing
...
fprintf(['Area of the wing = %f\n', ...
        ...
        SWing, b_span_Wing, MAC, SHori, Arm_LHori, b_span_Hori, Chord_Hori, ...
